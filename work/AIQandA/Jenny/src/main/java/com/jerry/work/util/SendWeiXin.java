...
public class SendWeiXin {
    ...
    private static TmpMapper tmpMapper;

    public static void sendWeiXin(String url,String tmpId, String openId, String clickUrl, String first, Map<String,String> keyWords, String remark) throws Exception{
    ...
    public static void sendWeiXin(String event, String openId, String clickUrl, String first, Map<String,String> keyWords, String remark) throws Exception{
        tmpMapper = getBean(TmpMapper.class);
        String jiayimuban = "";
        ...
        Tmp tmp = tmpMapper.findByEvent(event);
        tmpId = tmp.getdTmpId();
