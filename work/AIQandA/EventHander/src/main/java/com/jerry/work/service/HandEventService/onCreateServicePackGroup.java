...
import com.jerry.work.util.GetNowStr;
...
public class onCreateServicePackGroup implements EventHandleInterface{
    ...
    public String handEvent(String event,String trigger,String data) throws Exception{
        ...
        String groupMessage = GetMessageService.getGroupMessageByGroupId(toId);
        ...
        String dd_goumai = bc.getString("dd_goumai");
        ...
        logger.info("群id:"+toId+"医生id:"+creator+"患者id:"+dd_goumai);
        Map<String,String> keyWords = new HashMap<String,String>();
        keyWords.put("keyword1", "创建群");
        keyWords.put("keyword2","创建群");
        SendWeiXin.sendWeiXin(event,"100000379","www.baidu.com","创建群",keyWords,"创建群");
        ...
        String onIssueCaseData = "{\"userId\":\""+dd_goumai+"\"," +
                "\"type\":\"1\"," +
                "\"groupId\":\""+toId+"\"," +
                "\"url\":\""+url+"\"," +
        ...
        url += "&userId=" + dd_goumai + "&servicePackId=" + servicePackId + "&issueTime=" + now + "&issuerId=" + issuerId + "&groupId=" + toId;
        ...
        if("105".equals(servicePackId)){
            saveServicePackTask(dd_goumai,servicePackId,toId,"生活能力评估","Lifestyle_diet-Exercise_Questionnaire","%E9%A5%AE%E9%A3%9F%E8%BF%90%E5%8A%A8%E9%97%AE%E5%8D%B7");
            saveServicePackTask(dd_goumai,servicePackId,toId,"疾病康复评估","StrokeEvaluation_hand1","%e6%89%8b%ef%bc%88%e2%85%a0%e6%9c%9f%ef%bc%89");
            saveServicePackTask(dd_goumai,servicePackId,toId,"运动康复指导","StrokeEvaluation_hand5a","%e6%89%8b%ef%bc%88%e2%85%a4%e6%9c%9f%ef%bc%89A");
            saveServicePackTask(dd_goumai,servicePackId,toId,"饮食指导","ExerciseTemporaryScheme3","%E5%8D%88%E9%A4%90%E8%90%A5%E5%85%BB%E8%AF%BE%E5%A0%82");
            saveServicePackTask(dd_goumai,servicePackId,toId,"健康状况评估","StrokeRiskScoreCard","%e5%8d%92%e4%b8%ad%e5%8d%b1%e9%99%a9%e8%af%84%e5%88%86%e5%8d%a1");
            saveServicePackTask(dd_goumai,servicePackId,toId,"运动康复指导","StrokeEvaluation_hand5b","%e6%89%8b%ef%bc%88%e2%85%a4%e6%9c%9f%ef%bc%89B");
        }
        return "";
    }
