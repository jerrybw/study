 ...
 */
public class GetToxinTestResult implements GetResultInter
{
    @Override
    public String getResult(Map<String,List<T_variable>> param) {
        ...
        String result = "";
        if(score >= 0 && score <= 6){
            result = "你可能轻度中毒                “6周健康饮食疗法”：完成本书第三部分所列的6周计划";
        }else if (score >=7 && score <= 9){
            result = "你可能中度中毒                 自我护理：完成本书第三部分所列的6周计划同时根据第15章所推荐的自我护理方法排除毒素";
        } else if (score >= 10){
